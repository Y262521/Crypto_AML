  ...
  <div style={{ width: '220px', minWidth: '220px', height: '100vh', background: '#0F1829', display: 'flex', flexDirection: 'column', borderRight: '1px solid rgba(201,168,76,0.14)', flexShrink: 0 }}>
    ...
    {onHome && (
      <div style={{ padding: '12px 12px 4px' }}>
        <button
          onClick={onHome}
          style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 12px', background: 'rgba(201,168,76,0.07)', color: '#C9A84C', border: '1px solid rgba(201,168,76,0.14)', borderRadius: '8px', cursor: 'pointer', fontSize: '11px', fontWeight: '600' }}
          ...
          {items.map(item => {
            ...
            return (
              <button
                ...
                style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '9px', padding: '9px 12px', marginBottom: '2px', background: active ? 'rgba(201,168,76,0.12)' : 'transparent', color: active ? '#E2C97E' : '#CBD5E1', border: active ? '1px solid rgba(201,168,76,0.22)' : '1px solid transparent', borderRadius: '8px', cursor: 'pointer', fontSize: '12px', fontWeight: active ? '600' : '400', textAlign: 'left', transition: 'all 0.15s' }}
